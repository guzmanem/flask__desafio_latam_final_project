...
def instructions():
   response = jsonify({
      "average_psu": "Tipo numérico, nota obtenida del PSU.",
		...
		"cod_pro_rbd": "Tipo numérico, código del instituto (ver excel de la app web)",
		"cod_depe2": "Tipo numérico, código de dependencia del establecimiento (ver excel de la app web).",
		...
		"cod_jor": "Tipo numérico, tipo de jornada (ver excel de la app web).",
		"cod_des_cur": "Tipo numérico, descripción del curso (0: No aplica, 1: Sólo Liceo, 2: Dual, 3: Otro).",
